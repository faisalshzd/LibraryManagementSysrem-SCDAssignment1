...
class Magazine extends Publication {
    ...
    @Override
public double calculateCost() {
    return getPrice() * getPopularityCount();
}
}
class Newspaper extends Publication {
    ...
    @Override
public double calculateCost() {
    return 10 + 5; // Fixed cost of 10 + Publisher Charges of 5
}
    }
 class Borrower {
    private int userId;
   ...
   // Exit
    ...
    if (publicationType == 1) {
        ...
        double newcost=newBook.calculateCost();
         LibraryItem libraryItem = new LibraryItem(nextId, title, popularityCount,newcost);
        ...
        library.addPublication(newMagazine);
         double newcost=newMagazine.calculateCost();
         System.out.println(newcost);
         LibraryItem newLibraryItem = new LibraryItem(nextId, title, popularityCount,newcost);
        ...
        LibraryItem newLibraryItem = new LibraryItem(nextId, title, popularityCount,15);
        newLibraryItem.setBorrowed(false);
        library.addLibraryItem(newLibraryItem);
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            String[] parts = line.split(", "); 
                ...
                int popularityCount = Integer.parseInt(parts[parts.length - 2]);
                 int price = Integer.parseInt(parts[parts.length - 1]);
                 double newcost=(popularityCount*price);
                LibraryItem libraryItem = new LibraryItem(id, title, popularityCount,newcost);
                library.addLibraryItem(libraryItem);
                 }
                 if (id == 3) {
                int popularityCount = Integer.parseInt(parts[parts.length - 2]);
                LibraryItem libraryItem = new LibraryItem(id, title, popularityCount,15);
                library.addLibraryItem(libraryItem);
                 }
                if (1==id) {
